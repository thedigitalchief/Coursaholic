...
export default function Home() {
  ...
  return (
    <HeroLayout>
      <Head>
        <title>Coursaholic</title>
        {/* Change this icon when we have a logo */}
        <link rel="icon" href="/<company-logo.svg>" />
      </Head>
      ...
      <section className={`${styles.hero} ${styles.centered}`}>
        <div className={styles.content}>
          ...
          <h1 className={styles.title}>
            <br/><span> Coursaholic</span>
            <br/> <h1 style={{ fontSize: "1.8rem" }}>The best place to find all course reviews and getting registered.</h1>
          </h1>
      ...
      <section className={styles.heroreverse}>
        ...
        <div className={styles.content}>
          ...
          <p>
            ...
            courseload. Coursaholic provides you with a preview of a class that you
          ...
          <p>
            ...
            students&#39; reviews, Coursaholic can help students be better preparose
            for future quarters.
          </p>
      ...
      <section className={styles.hero}>
        <div className={styles.content}>
          ...
          <p>
            ...
            life balance through Coursaholic.
          </p>
          <h2>Promote Your Events</h2>
          <p>
            No need to create flyers for your events. Instantly share any
            changes so no one misses out. Coursaholic will create the hype for you
            with a single post.
          </p>
      ...
      <section className={styles.heroreverse}>
        ...
        <div className={styles.content}>
          ...
          <p>
            ...
            eye. Use Coursaholic as a tool to discover more about yourself.
          </p>
          ...
          <p>
            ...
            Organizations can always rely on Coursaholic to keep their members in
            touch.
          </p>
