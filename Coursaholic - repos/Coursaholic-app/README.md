...
<p align="center">
<img src="/documentation/images/Banner.png" alt="cover page for Coursaholic, Inc.">
</p>
&nbsp;
...
Coursaholic is the one-stop shop for a student at UCR hosting information on different clubs, organizations, and events as well as reviews on classes provided by other students. We want the students that use this site to be as informed as possible about what is currently going on on campus.
...
<img align="left" src="/documentation/images/dylannguyen.png" alt="image of Dylan Nguyen" width="75" height="75">

Hey I'm Dylan! You can find out more about me on my [Portfolio](https://dylanhnguyen.com) or my [Github](https://github.com/thedigitalchief). 
...
```
Given: mongodb+srv://digitalchief:goodkarma@cluster0.qhvo8.mongodb.net/CoursaholicDatabase?retryWrites=true&w=majority
```

5. This link represents your **MONGODB_URI** where you will replace `<user>`, `<password>`, and `myFirstDatabase` with your respective values without `<>`. so mine is: mongodb+srv://digitalchief:goodkarma@cluster0.qkiwn.mongodb.net/?retryWrites=true&w=majority

mongodb+srv://digitalchief:goodkarma@cluster0.qkiwn.mongodb.net/?retryWrites=true&w=majority
...
<p align="center">
<img src="/documentation/images/LandingLight.png" alt="image of Coursaholic' landing page">
</p>
&nbsp;
...
<p align="center">
<img src="/documentation/images/CoursesDark.png" alt="image of Coursaholic' courses page">
&nbsp;
 </p>
 &nbsp;
...
Our Events page features upcoming events from organizations registered with Coursaholic. Here, users can see all events and their info all in one place.

<p align="center">
<img src="/documentation/images/EventsLight.png" alt="image of Coursaholic' events page">
&nbsp;
</p>
&nbsp;
...
Our Organization page features organizations registered with Coursaholic. Functionality includes allowing users to become members of organizations.

<p align="center">
<img src="/documentation/images/OrganizationsDark.png" alt="image of Coursaholic' organization page">
&nbsp;
</p>
&nbsp;
...
<p align="center">
<img src="/documentation/images/OpportunitiesLight.png" alt="image of Coursaholic' organization page">
&nbsp;
</p>
&nbsp;
